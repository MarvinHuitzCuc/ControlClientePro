                            ...
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                     ...
                                     <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="direction" placeholder="Ingrese su Direccion" class="form-control" value="<?php echo $model1->Direction ?? "" ?>"  onkeypress="new Client().ClearMessages(this);"/>
